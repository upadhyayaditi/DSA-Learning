...
public class PostorderTraversal {
    ...
    // BinaryTree class to build a binary tree using recursion and perform postorder traversal
    ...
    public static void main(String args[]) {
        ...
        tree.postorder(root); // Perform postorder traversal starting from the root node
    }
}
